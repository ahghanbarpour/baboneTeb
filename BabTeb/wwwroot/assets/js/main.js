(function($) {
  ...
  // Countdown
    $('[data-countdown]').each(function() {
        ...
        $template = `<div class="countdown-item"><span class="label">روز</span><span class="number">%D</span></div><div class="countdown-item"><span class="label">ساعت</span><span class="number">%H</span></div><div class="countdown-item"><span class="label">دقیقه</span><span class="number">%M</span></div><div class="countdown-item"><span class="label">ثانیه</span><span class="number">%S</span></div>`;
